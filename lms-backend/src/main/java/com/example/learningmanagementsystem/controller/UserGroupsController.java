...
import com.example.learningmanagementsystem.service.UserGroupsService;
...
@RestController
@RequestMapping("/api/users_groups")
public class UserGroupsController {
    @Autowired
    UserGroupsService userGroupsService;

    @PostMapping("/add")
    public HttpEntity<?> add(@RequestBody UserGroupsDTO userGroupsDTO) {
        ApiResult add = userGroupsService.add(userGroupsDTO);
